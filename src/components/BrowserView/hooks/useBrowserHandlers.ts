    ...
    async (url: string) => {
      ...
      try {
        const res = await crawlService.analyzePage(target, {
          ...
          smartWaitDomStabilizedEnabled: crawlSettings.smartWaitDomStabilizedEnabled,
          preExtractDelayMs: crawlSettings.preExtractDelayMs,
          domStabilizedQuietMs: crawlSettings.domStabilizedQuietMs,
          domStabilizedPollMs: crawlSettings.domStabilizedPollMs,
          domStabilizedTimeoutMs: crawlSettings.domStabilizedTimeoutMs,
