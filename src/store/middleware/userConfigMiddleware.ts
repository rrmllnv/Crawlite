  ...
  if (actionType && actionsToSave.includes(actionType as string)) {
    ...
    void userConfigManager.update({
      ...
      crawling: {
        ...
        smartWaitDomStabilizedEnabled: state.crawl.settings.smartWaitDomStabilizedEnabled,
        preExtractDelayMs: state.crawl.settings.preExtractDelayMs,
        domStabilizedQuietMs: state.crawl.settings.domStabilizedQuietMs,
        domStabilizedPollMs: state.crawl.settings.domStabilizedPollMs,
        domStabilizedTimeoutMs: state.crawl.settings.domStabilizedTimeoutMs,
        ...
        pageLoadTimeoutMs: state.crawl.settings.pageLoadTimeoutMs,
      },
      sitemap: {
